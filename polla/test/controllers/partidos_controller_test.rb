...
class PartidosControllerTest < ActionController::TestCase
  ...
  test "should create partido" do
    assert_difference('Partido.count') do
      post :create, partido: { equipo1: @partido.equipo1, equipo2: @partido.equipo2, res1: @partido.res1, res2: @partido.res2 }
    end
  ...
  test "should update partido" do
    patch :update, id: @partido, partido: { equipo1: @partido.equipo1, equipo2: @partido.equipo2, res1: @partido.res1, res2: @partido.res2 }
    assert_redirected_to partido_path(assigns(:partido))
  end
